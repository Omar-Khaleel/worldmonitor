...
| `broadcast-station-check.yml` | PR and broadcast branch changes | Isolated control/viewer routing, live state API, lightweight bundle size, refresh behavior, and no-reload Playwright update test |
